...
function botmessage(name, img, side, text,text2,cls) {
  //   Simple solution for small apps
  ...
  const msgHTML = `
    ...
    <div class="msg right-msg">
      ...
      <div class="msg-bubble_user_res">
        <div class="msg-info">
          <div class="msg-info-name">Speek</div>
          
        </div>
         
        <div class="msg_line">
          <div id="word-spoken2" class="msg-text">${text2}</div>
          <button  onclick="responsiveVoice.speak('${text2}','US English Female');" 
          type="button" value="Play" class="voice_play voice_play_user">
          <i class="fas fa-play-circle"></i>
            </button>
        </div>
      </div>
